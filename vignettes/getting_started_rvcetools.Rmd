...
What is shown in the above code-junk can be done in one step using the function `parameter_varCovar_mix99()` with an input and an output file as parameter.
